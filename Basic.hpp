...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0D7AF0F0;
	constexpr int32 AppendString      = 0x01508670;
	constexpr int32 GetNameEntry      = 0x015093A0;
	constexpr int32 GNames            = 0x0DAF4C80;
	constexpr int32 GWorld            = 0x0DAC59E8;
	constexpr int32 ProcessEvent      = 0x017BE7B0;
